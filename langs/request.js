export default {
  ...
  subtitle: {
    en: `You have successfully authorized in InnoStudent as user. It means
        ...
        you are interested in it. In the first field, provide your telegram alias
        that we could contact you, and then write why do you want to be an author
        and do you have an experience in similar work.`,
    ru: `Вы удачно авторизовались в InnoStudents в качестве пользователя. Это
